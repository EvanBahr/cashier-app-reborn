...
export default function Warung() {
  ...
  const tamplAlert = () => {
    if (pesanan.name.length < 1) {
      ...
      alert("Tulis pesanan anda terlebih dahulu");
      setNotatampl("hide");
    }
  };
  ...
  return (
    <div>
      <div className="xl:px-10 xl:pt-10 bg-purple-100">
        ...
        <div className="mt-5 xl:grid grid-cols-5 text-center gap-2">
          <div className="p-3 bg-green-200 rounded-lg max-h-[750px] overflow-y-auto ">
            <div className="uppercase rounded-2xl font-bold h-16 bg-green-700  text-white p-5 ">
              DATA PESANAN
            </div>
            ...
            >
              <div>
                <div className="text-left ml-3 font-semibold ">
                  Tempat duduk
                </div>
                <div>
              ...
              >
                ...
                <div>
                  {keranjang.map((v, i) => (
                    <div
                      key={i}
                      className="grid grid-cols-8 text-sm font-sans divide-y"
                    >
                      <div>{i + 1}.</div>
          ...
          <div className="col-span-3 ">
            <div className=" mx-2 xl:mx-0  xl:grid grid-cols-3 gap-3 max-h-[750px] overflow-y-auto">
              {ProdukWarung[pilih].map((v, i) => (
                <div
                  key={i}
                  className="grid xl:grid-cols-2 grid-cols-3 my-2 xl:my-0 p-4 border-2  border-black rounded-lg"
                  onClick={() => {
                    pesan(v);
                  }}
                >
                  <div className="xl:h-28 h-14  text-sm xl:text-base rounded-xl bg-blue-200 text-center xl:p-4 p-2 font-extrabold">
                    Data Dummy ^_^
                  </div>
                  <div>
